...
public interface IProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query(nativeQuery = true, value = "SELECT p.id, p.name, p.product_code, p.qr_code, p.gender, p.price, c.name, pm.percent\n" +
            ...
            "LEFT JOIN promotions pm ON p.promotion_id = pm.id\n" +
            "WHERE c.id := param;")
    Page<Product> findAllProductsByCategory(@Param("param") Integer chosenId ,Pageable pageable);
    ...
    Page<Product> findAllProductsByName(@Param("param") String name ,Pageable pageable);
